...
class Ui_MainWindow(object):
    ...
    def retranslatiUi(self, MainWindow):
    ...
    def trainingFunction(self):
        ...
        training_set = train_datagen.flow_from_directory(
            'C:\TOSHIL KUMBHALKAR\Downloads\Covid19_Detection_project\Covid19_Detection_project\TrainingDataset',
            target_size=(128, 128),
            batch_size=8,
        ...
        test_set = test_datagen.flow_from_directory(
            'C:\TOSHIL KUMBHALKAR\Downloads\Covid19_Detection_project\Covid19_Detection_project\TestingDataset',
            target_size=(128, 128),
            batch_size=8,
            class_mode='categorical')
